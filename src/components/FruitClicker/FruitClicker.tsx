...
const FruitClicker = () => {
  ...
  const handleClick = (event: React.MouseEvent) => handleTap(1, event.clientX, event.clientY);
    ...
    <div className="clicker-container">
      ...
      <div className='fruitbg'>
        ...
        >
          ...
          {isAnimating && (
            <div
              className={`tap-count ${tapCount > 1 ? 'tap-count-multi' : ''}`}
              style={{ top: tapPosition.y - 30, left: tapPosition.x }}
            >
              +{tapCount}
            </div>
          )}
